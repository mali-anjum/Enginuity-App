...
export default function OnboardingEducationScreen() {
  ...
  const [type, setType] = useState<InstitutionType | null>(draft.institutionType);
  ...
  return (
    <ThemedView style={styles.screen}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <AuthTextInput placeholder="School, university, company, or lab name" value={name} onChangeText={setName} />
        <AuthTextInput
        ...
        <View style={styles.row}>
          ...
          <Pressable style={[styles.primary, { backgroundColor: themeColors.primary }]} onPress={saveAndNext}>
