...
import { Fonts } from '@/modules/common/constants/theme';
import { Collapsible } from '@/modules/common/molecules/collapsible';
import { ExternalLink } from '@/modules/common/molecules/external-link';
import ParallaxScrollView from '@/modules/common/organisms/parallax-scroll-view';
    ...
    <ParallaxScrollView
      ...
      <Collapsible title="File-based routing">
        <ThemedText>
          ...
          <ThemedText type="defaultSemiBold">src/modules/common/screens/home-screen.tsx</ThemedText>{' '}
          and <ThemedText type="defaultSemiBold">src/modules/common/screens/explore-screen.tsx</ThemedText>
        </ThemedText>
        <ThemedText>
