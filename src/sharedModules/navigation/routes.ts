...
export const routePaths = {
  ...
  experimentDetail: (experimentId: string): Href => `/experiment/${experimentId}` as Href,
  experimentEdit: (experimentId: string): Href => `/experiment/${experimentId}/edit` as Href,
  ...
  notesCreateForExperimentWithTitle: (experimentId: string, title: string): Href =>
    `${ROUTES.notesCreate}?experimentId=${encodeURIComponent(experimentId)}&title=${encodeURIComponent(title)}` as Href,
  experimentAttachmentViewer: (url: string, fileName: string, fileType: string): Href =>
  ...
  hardwareDetail: (hardwareId: string): Href => `/hardware/${hardwareId}` as Href,
  hardwareEdit: (hardwareId: string): Href => `/hardware/${hardwareId}/edit` as Href,
} as const;
