...
- Redirect policy is centralized in `src/auth/services/auth-redirect-policy.ts`.
...
- Route guard unit tests live in `src/auth/services/auth-redirect-policy.test.ts`.
